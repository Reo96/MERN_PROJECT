...
const AuthScreen = () => {
  ...
  return (
    <div className='hero-bg relative'>
       ...
       <div className ='flex flex-col items-center justify-enter text-center py-40 text-white max-w6xl mx-auto'>
        <h1 className='text-4xl md:text-6xl font-bold mb-4'>Unlimited Movies, TV shows and More</h1>
        <p className = 'text-lg mb-4'>watch anywhere. Cancel anytime</p>
        <p className='mb-4'>Ready to watch? Enter your Email to create or restart your membership</p>
        <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={ handleForm }>
            <input type='email' placeholder='Email address' className=' p-2 rounded flex-1 bg-black/80 border border-gray-700' value={email}
        ...
        <div className='py-10 bg-black text-white'>
          ...
          <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
            <div className='flex-1 text-center md:text-left'>
              <h2 className='text-4xl md:text-5xl font-extrabold mb-4 text-balance'>Enjoy on your TV.</h2>
          ...
          <div className='h-2 w-full bg-[#232323]'aria-hidden='true'></div> 
          {/* second section */}
          <div className='py-10 vg-black text-white'>
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
              <div className='felx-1 relative'>
                <div className='relative'>
                  ...
                  <div className='flex item-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2 '>
          ...
          <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
            <div className='flex-1 text-center md:text-left'>
              <h2 className='text-4xl md:text-5xl font-extrabold mb-4 text-balance'>Watch everyehere</h2>
              <p className='text-lg md:text-xl'>Stream unlimited movies and TV shows on your phone, tablet, laptop and TV.</p>
              
            </div>
            <div className='flex-1 relative overflow-hidden'>
              <img src="/device-pile.png" alt="device img" className='mt-4 z-20 relative' />
              <video className='absolute top-2 left-1/2 -translate-x-1/2 h-2/3 z-10 max-w-[63%]'
              playsInline autoPlay muted loop
              >
          ...
          <div className='flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2'>
            <div className='flex-1 relative'>
              <img src='/kids.png' alt="Tv pic" className='mt-4'/>
            </div>
            <div className = 'flex-1 text-center md:text-left'>
